                ...
                if (AppEnvConfig.Mode == AppEnvConfig.AppMode.NameLabel)
                {
                    ...
                    try
                    {
                        var layout = new
                        {
                            ...
                            barcodeScale = AppEnvConfig.NameLabelBarcodeScale,
                            barcodeWidthMm = AppEnvConfig.NameLabelBarcodeWidthMm,
                            barcodeHeightMm = AppEnvConfig.NameLabelBarcodeHeightMm,
                            barcodeOffsetXMm = AppEnvConfig.NameLabelBarcodeOffsetXMm,
                            barcodeOffsetYMm = AppEnvConfig.NameLabelBarcodeOffsetYMm,
                            ...
                            overflowBaseChars = AppEnvConfig.NameLabelOverflowBaseChars,
                            overflowSpacingPx = AppEnvConfig.NameLabelOverflowSpacingPx,
                            overflowFontRatio = AppEnvConfig.NameLabelOverflowFontRatio,
